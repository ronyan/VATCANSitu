...
const COLORREF C_GREY = RGB(200, 200, 200);
const COLORREF C_PPS_ORANGE = RGB(242, 120, 57);
const COLORREF C_PPS_YELLOW = RGB(255, 255, 195);
const COLORREF C_PPS_DARK_YELOW = RGB(185, 186, 115);
// 202, 205, 169
const COLORREF C_PPS_MAGENTA = RGB(197, 38, 212);
const COLORREF C_PPS_RED = RGB(206, 47, 47);
const COLORREF C_TAG_BLUE = RGB(140, 210, 230);
const COLORREF C_TAG_GREEN = RGB(85, 205, 75);
const COLORREF C_TAG_RED = RGB(206, 47, 47);
const COLORREF C_TAG_AMBER = RGB(252, 253, 168);
const COLORREF C_TAG_ORANGE = RGB(252, 165, 0);
...
const int LIST_DEPARTURES = 8003;
const int LIST_ARRIVALS = 8004;
const int LIST_ACTIVE = 8005;
const int LIST_VFR_CONTROL = 8006;
const int LIST_VFR_COLLECTOR = 8007;
const int LIST_HOLD = 8008;
const int LIST_COAST = 8009;
const int LIST_CONFLICT = 8010;
const int LIST_ARR_A = 8011;
const int LIST_ARR_B = 8012;
const int LIST_ARR_C = 8013;
const int LIST_ARR_D = 8014;
const int LIST_ARR_E = 8015;
...
const int WINDOW_ALTITUDE_SLIDER = 6010;